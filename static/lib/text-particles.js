...
function accelerate(opt) {
  ...
  options.textList = (opt.textList || "Embedded Systems, Linux, Raspberry, Python, C# WPF, Android Studio, Software Development, C/C++, PowerShell, Angular Js, Grafana, Node Red, Flutter, Internet Of Things (IoT), BlueTooth Low Energy (BLE), Java, Qt Design, Solid Works (3D), Unity 3D, Krita, Html/Css, Mobile Development, Web Development").split(', '); // string: list of strings separated with a comma and a space
